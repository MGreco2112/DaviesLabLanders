...
public class ADCPHeadResponse {
    ...
    public void createDataResponse(ProcessedADCPData newData) {
        ADCPDataResponse res = new ADCPDataResponse(newData.getID(), newData.getDate());
        data.add(res);
    }

    public void createFullDataResponse(ProcessedADCPData newData) {
    ...
    private class ADCPDataResponse {
        ...
        public ADCPDataResponse(Long id, LocalDateTime date) {
            this.ID = id;
            this.Date = date;
        }
